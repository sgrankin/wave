...
func New(store storage.AttachmentStore, access AccessChecker, identify func(*http.Request) (id.ParticipantID, bool)) *Handler {
	return &Handler{store: store, access: access, identify: identify}
}
...
func (h *Handler) upload(w http.ResponseWriter, r *http.Request) {
	...
	// Count bytes as they stream to the store so the metadata size is exact.
...
func (h *Handler) setThumbnail(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.store.PutThumbnail(attachmentID, r.Body); err != nil {
